                ...
                <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:items-center md:gap-x-12 lg:gap-x-20">
                    <div>
                        <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                            Performance Improvement Through Behavioural Alignment
                        </h1>
                        <p className="mb-5 text-base md:mb-6 md:text-md">
                            This intervention is ideal when productivity, accountability, or communication is breaking down across teams.
                        </p>
                        <p className="mb-5 text-base md:mb-6 md:text-md">
                        ...
                        <div className="py-2">
                            <h3 className="mb-3 font-bold text-md">How We Drive Measurable Performance</h3>
                        ...
                        <div className="mt-6 md:mt-8">
                            <Link to="/contact">
                                <Button variant="secondary" title="Request a Performance Diagnosis">
                                    🔵 Request a Performance Diagnosis
                                </Button>
                            </Link>
                        </div>
